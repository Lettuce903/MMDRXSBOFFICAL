...
export var pickups_drop_enabled = false
...
export (PackedScene) var special_obj_item : PackedScene
...
func spawn_pickup_by_name(pickup_name : String):
	...
	match pickup_name:
		...
		PICKUP_LIFE:
			...
			pickup_object.global_position = global_position
		PICKUP_SPECIAL:
			pickup_object = special_obj_item.instance()
			get_parent().add_child(pickup_object)
			pickup_object.global_position = global_position
